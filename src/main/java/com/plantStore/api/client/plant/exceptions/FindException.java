...
import com.plantStore.api.client.plant.errors.InvalidIdSuppliedError;
import com.plantStore.api.client.plant.errors.PlantNotFoundError;
...
public final class FindException extends Exception {
  ...
  public static FindException plantNotFoundError(PlantNotFoundError value) {
    return new FindException(new PlantNotFoundErrorValue(value), 404);
  }

  public static FindException invalidIdSuppliedError(InvalidIdSuppliedError value) {
    return new FindException(new InvalidIdSuppliedErrorValue(value), 400);
  }
  ...
  private static final class PlantNotFoundErrorValue implements Value {
    ...
    public String toString() {
      return "FindException{" + "value: " + value + ", errorInstanceId: " + errorInstanceId + "}";
    }
  }
