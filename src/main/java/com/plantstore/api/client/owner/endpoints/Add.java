...
import com.plantstore.api.client.owner.types.AddOwnerRequest;
...
public final class Add {
  ...
  public static final class Request {
    private final AddOwnerRequest body;

    private final Optional<BearerAuth> authOverride;

    private int _cachedHashCode;

    Request(AddOwnerRequest body, Optional<BearerAuth> authOverride) {
      this.body = body;
      this.authOverride = authOverride;
    }

    public AddOwnerRequest getBody() {
      return body;
    }
    ...
    public interface BodyStage {
      _FinalStage body(AddOwnerRequest body);
    ...
    public static final class Builder implements BodyStage, _FinalStage {
      ...
      @Override
      public _FinalStage body(AddOwnerRequest body) {
        this.body = body;
        return this;
      }
