...
public final class Plant {
  ...
  Plant(Optional<UUID> id, Optional<PlantCategory> category, String name,
  ...
  public String toString() {
    return "Plant{" + "id: " + id + ", category: " + category + ", name: " + name + ", photoUrls: " + photoUrls + ", status: " + status + "}";
  }
  ...
  public static final class Builder implements NameStage, _FinalStage {
    ...
    @Override
    public Plant build() {
      return new Plant(id, category, name, photoUrls, status);
    }
  }
}
